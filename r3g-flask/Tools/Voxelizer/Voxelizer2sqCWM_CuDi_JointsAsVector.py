...
class Voxelizer2sqCWMSoupler_CuDi_JointsAsVector(Voxelizer2sqCWMSoupler_CuDi):
    ...
    def __init__(self, sizeBoxInit, thresholdToleranceCuDi, doRectifyAngle, threshCurviDist, thresholdToleranceForVoxelization, nbJoint,jointSelected):
        super(Voxelizer2sqCWMSoupler_CuDi_JointsAsVector, self).__init__(sizeBoxInit, thresholdToleranceCuDi, doRectifyAngle, threshCurviDist, thresholdToleranceForVoxelization,jointSelected)
